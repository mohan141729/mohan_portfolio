...
const Certifications = () => {
  ...
  if (loading) {
    return (
      <section className="py-24 w-screen min-h-[80vh] bg-gradient-to-b from-white via-blue-50 to-white flex flex-col items-center" id="certifications">
        <h2 className="text-4xl font-extrabold text-center text-gray-900 mb-2 tracking-tight">Certifications & Resume</h2>
        <p className="text-gray-400 text-center mb-12 max-w-2xl">Professional certifications and achievements that validate my expertise.</p>
    ...
    <section className="py-24 w-screen min-h-[80vh] bg-gradient-to-b from-white via-blue-50 to-white flex flex-col items-center" id="certifications">
      ...
      <div className="w-full max-w-6xl flex flex-col gap-8 px-4">
        ...
        <motion.div
          ...
          className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-gray-200 p-8 text-center"
        >
          <div className="mb-6">
            <div className="text-6xl mb-4">📄</div>
            <h3 className="text-2xl font-bold text-gray-900 mb-2">Download Resume</h3>
            <p className="text-gray-600">Get a detailed overview of my experience and skills</p>
          </div>
          <button 
            onClick={handleDownloadResume}
            disabled={!resume}
            className="bg-gradient-to-r from-blue-500 to-purple-500 text-white px-8 py-3 rounded-xl hover:from-blue-600 hover:to-purple-600 transition-all duration-200 font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
          >
              ...
              <div className="p-6">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  {certification.expiry_date && (
                    <div className="flex items-center gap-2 text-gray-600">
                      <FaCalendarAlt size={14} />
                      <span className={`text-sm ${isExpired(certification.expiry_date) ? 'text-red-600' : ''}`}>
